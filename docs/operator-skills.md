...
| Skill | Say this | Note |
|------|----------|------|
| `coffee` | **coffee** | Canonical cadence skill; **signing-off** intent = handoff-weighted Step 1, **same** **A–E** menu (Build, Steward, Strategy/daily brief, Write, system choice — **B** alone after signing-off = system pick when no sub-track). Legacy **hey** still works. |
