...
|------|---------|-----------------|
| `daily-warmup` | **Good morning:** **Step 1** (warmup + harness, **KY-4 polling + Polymarket**, Massie X — **no** daily brief generator; **menu C** for brief + §1d Putin) + **Step 2** **A–F** (**A** template + boundary, **B** repository hygiene, **C** Daily brief, **D** RECURSION-GATE review, **E** work-dev *or* work-strategy *or* work-politics — one lane when chosen, **F** end morning). **Good night:** **Step 1** `operator_handoff_check.py` + summary + **Step 2** **A–F** — **A–D** same as good morning (**D** = gate); **E** night system pick (closeouts); **F** end night session. See [polling-and-markets.md](skill-work/work-politics/polling-and-markets.md) and `.cursor/skills/daily-warmup/SKILL.md` § *Shared A–C* / § *Shared D* | Morning: `operator_daily_warmup.py` + agent steps; night: `operator_handoff_check.py` + agent steps |
