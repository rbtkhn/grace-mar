...
| Skill | Say this | Note |
|------|----------|------|
| `coffee` | **coffee** | Canonical cadence skill; **signing-off** intent = handoff-weighted Step 1, **same** fixed menu (**A**, **B**, **C**, **D1–D5**, **E**) with five explicit conductor picks. **B** alone after signing-off = system pick when no sub-track. Legacy **hey** still works. |
