...
| **Audits** | [audit-companion-self](audit-companion-self.md), [AUDIT-GRACE-MAR-VS-COMPANION-SELF-TEMPLATE](audit-grace-mar-vs-companion-self-template.md), [audit-structural-alignment-grace-mar-companion-self-companion-xavier](audit-structural-alignment-grace-mar-companion-self-companion-xavier.md), [audit-boundary-grace-mar-companion-xavier-companion-self](audit-boundary-grace-mar-companion-xavier-companion-self.md) | Companion-self concept alignment; instance vs template; **three-way** structure + formatting; **normative boundaries** (Record · template · instance; what may cross). |
| **companion-xavier seed** | [work-companion-xavier/README](skill-work/work-companion-xavier/README.md) | Monorepo subtree + Session 0 MCQ; interface (`SEED-MANIFEST`, `LEAKAGE-CHECKLIST`); **no** grace-mar Record copy. |
