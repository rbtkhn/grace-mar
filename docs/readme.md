...
| **companion-xavier seed** | [work-xavier/README](skill-work/work-xavier/README.md) | Monorepo subtree + Session 0 MCQ; interface (`SEED-MANIFEST`, `LEAKAGE-CHECKLIST`); **no** grace-mar Record copy. |
