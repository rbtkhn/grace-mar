...
| **Conductor proposal lenses (coding prompts)** | [skill-work/work-dev/conductor-proposal-lenses.md](skill-work/work-dev/conductor-proposal-lenses.md) | PR proposal shapes per conductor; Beethoven test appendix; WORK prompt convention only. |
