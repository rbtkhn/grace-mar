...
| **Audits** | [audit-companion-self](audit-companion-self.md), [AUDIT-GRACE-MAR-VS-COMPANION-SELF-TEMPLATE](audit-grace-mar-vs-companion-self-template.md), [audit-structural-alignment-grace-mar-companion-self-companion-xavier](audit-structural-alignment-grace-mar-companion-self-companion-xavier.md) | Companion-self concept alignment; instance vs template; **three-way** structure + formatting (grace-mar, companion-self, companion-xavier). |
