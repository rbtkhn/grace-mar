...
**Daily rhythm cards:** The dashboard includes a static **A–F** reference strip (good morning / good night Cursor menu roles) plus links to [work-menu-conventions.md](skill-work/work-menu-conventions.md), [daily-warmup SKILL](../.cursor/skills/daily-warmup/SKILL.md), and [suggest_morning_forks.py](../scripts/suggest_morning_forks.py). No server logic — glanceable only.
