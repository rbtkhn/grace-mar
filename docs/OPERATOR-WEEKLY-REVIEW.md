...
| 3 | **Skim VOICE-ARCHIVE** — Glance at recent exchanges in `users/[id]/VOICE-ARCHIVE.md`. Note resistance, recurring topics, and continuity cues for next session. | ~5 min |
...
- **Skim VOICE-ARCHIVE** — Builds continuity; operator enters the next week with context.
