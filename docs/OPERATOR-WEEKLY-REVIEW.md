...
| 2 | **Rotate MEMORY** — If using `users/[id]/MEMORY.md`, prune or clear entries older than 7 days. Update "Last rotated" in header. See [MEMORY-TEMPLATE](MEMORY-TEMPLATE.md). | ~5 min |
| 3 | **Skim ARCHIVE** — Glance at recent exchanges in `users/[id]/ARCHIVE.md`. Note any resistance, recurring topics, or continuity cues for next session. | ~5 min |
