...
| **Session continuity receipts** | **Implemented contract:** [session-continuity-contract.md](session-continuity-contract.md) — files + `continuity_preflight.py` / `verify_continuity_receipt.py` + handback enforcement; not “agent remembers.” OpenClaw `/stage` requires a fresh valid receipt. |
...
7. OB1 chunking spike — when demand materializes: export one real `self.md` under each strategy, measure retrieval precision, pick the winner. Blocking prerequisite for the bridge exporter (PR 4). See `docs/integrations/ob1/architecture.md` § Known technical risks.
8. Apply risk-mitigation template (success criteria, sustainment, deprecation, scope creep) to remaining uncovered territories: ~~`work-politics`~~ (**done 2026-04-18** — see `docs/skill-work/work-politics/README.md` § *Risk mitigation (template — Tier 1+)*), ~~`work-civ-mem`~~ (**done 2026-04-18** — see `docs/skill-work/work-civ-mem/README.md` § *Risk mitigation (template — Tier 1+)*), ~~`work-cici`~~ (**done 2026-04-15** — see `docs/skill-work/work-cici/README.md` § *Risk mitigation (template — Tier 1+)*). Template: `docs/skill-work/work-template/README.md` § Risk-mitigation checklist. **Lane sweep complete** — use template when adding new long-lived WORK territories.
