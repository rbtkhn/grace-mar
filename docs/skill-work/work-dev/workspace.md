...
7. Apply risk-mitigation template (success criteria, sustainment, deprecation, scope creep) to remaining uncovered territories: ~~`work-politics`~~ (**done 2026-04-18** — see `docs/skill-work/work-politics/README.md` § *Risk mitigation (template — Tier 1+)*), ~~`work-civ-mem`~~ (**done 2026-04-18** — see `docs/skill-work/work-civ-mem/README.md` § *Risk mitigation (template — Tier 1+)*), ~~`work-xavier`~~ (**done 2026-04-15** — see `docs/skill-work/work-xavier/README.md` § *Risk mitigation (template — Tier 1+)*). Template: `docs/skill-work/work-template/README.md` § Risk-mitigation checklist. **Lane sweep complete** — use template when adding new long-lived WORK territories.
