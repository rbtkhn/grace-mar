...
4. Refresh stale derived exports (`manifest.json`, `llms.txt`, `intent_snapshot.json`, `fork-manifest.json`, PRP, runtime bundle). Validator flags these; run `refresh_derived_exports.py` after confirming no Record changes are pending.
