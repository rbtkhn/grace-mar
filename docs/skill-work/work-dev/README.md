...
| **[continuity-observability.md](continuity-observability.md)** | Continuity-block event export path: local `runtime/observability/continuity_blocks.jsonl` → derived operator artifact; WORK-only, no Record authority. |
