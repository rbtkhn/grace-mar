...
| **[dev-journal/README.md](dev-journal/README.md)** | **Dev journal** — short daily **reflection** on work-dev learning/building (parallel to [xavier-journal](../work-xavier/xavier-journal/README.md)); [Day 1](dev-journal/2026-04-09-day-01.md), [Day 2](dev-journal/2026-04-11-day-02.md); [daily-dev-journal-inbox.md](dev-journal/daily-dev-journal-inbox.md) (rolling buffer; fold at **`dream`**; prune when long); not Record, not a substitute for history or workspace. |
| **[dev-notebook/README.md](dev-notebook/README.md)** | **Dev notebook** — durable **prompts and spec snapshots** (e.g. [Cici Phase 1 governed-state prompt](dev-notebook/cici-phase-1-git-first-governed-state-prompt.md)); not day-scale journal. |
