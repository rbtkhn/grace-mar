...
| **thanks** | one **`thanks`** line via `log_cadence_event.py` | [thanks/SKILL.md](../../../.cursor/skills/thanks/SKILL.md) | **Deprecated** operator habit — prefer **conductor** | Legacy micro-pause if invoked |
