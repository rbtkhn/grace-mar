...
**Parent:** [Dev notebook (prompts + journal)](../README.md) — this subfolder is the **day-scale journal**; the notebook root also holds **prompts and spec captures**.
...
**Territory:** `docs/skill-work/work-dev/dev-notebook/journal/` in grace-mar — **WORK / operator trajectory**, not the companion **Record**, not Voice knowledge, not a substitute for [work-dev-history.md](../../work-dev-history.md) (append-only milestone log) or [workspace.md](../../workspace.md) (canonical entrypoint).
