...
Prints **active days (last 14)** and **staleness** per journal from **filenames** (`*-day-*.md` for dev-journal; `YYYY-MM-DD.md` for cici-notebook). No frontmatter required.
