...
**Scope:** Optional **telemetry on journaling practice** for [dev-journal](work-dev/dev-journal/README.md) and [xavier-journal](work-xavier/xavier-journal/README.md). **Not** Record truth, not gated merges, not a second history file (see [work-dev-history.md](work-dev/work-dev-history.md) / [work-xavier-history.md](work-xavier/work-xavier-history.md)).
...
Prints **active days (last 14)** and **staleness** per journal from **filenames** (`*-day-*.md` for dev-journal; `YYYY-MM-DD.md` for xavier-journal). No frontmatter required.
