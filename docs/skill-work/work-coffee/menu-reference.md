...
**Canonical Step 2 menu (grace-mar):** **six lines A–D2–E** — **A** Build, **B** Steward, **C** Strategy (daily brief), **D1** Conductor (continue last emphasis), **D2** Conductor (system recommended), **E** (system choice). **No** micro-hints line under the menu. Executable contract: [.cursor/skills/coffee/SKILL.md](../../../.cursor/skills/coffee/SKILL.md).
