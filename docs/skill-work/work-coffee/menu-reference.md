...
**Canonical Step 2 menu (grace-mar):** **six lines A–D2–E** — **A** Build, **B** Steward, **C** Strategy (daily brief), **D1** Conductor **with conductor name(s)** — continue last emphasis, **D2** Conductor **with conductor name(s)** — system recommended, **E** (system choice). **D1** / **D2** lines embed **Title Case** movement names (Toscanini, Furtwängler, Bernstein, Karajan, Kleiber) resolved per [CONDUCTOR-PASS.md](CONDUCTOR-PASS.md#conductor-d1-d2). **No** micro-hints line under the menu. Executable contract: [.cursor/skills/coffee/SKILL.md](../../../.cursor/skills/coffee/SKILL.md).
