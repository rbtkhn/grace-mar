...
**Audience:** Operator, product, or developer who wants to implement or refine a Record-derived lesson prompt generator. See also [alpha-school-reference](work-alpha-school/alpha-school-reference.md) (§ Record-driven prompts) and [grace-mar-vs-companion-self-skill-work](../grace-mar-vs-companion-self-skill-work.md).
