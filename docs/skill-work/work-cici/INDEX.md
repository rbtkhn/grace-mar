...
| **[Cici](https://github.com/Xavier-x01/Cici)** (external) | Xavier’s **OB1 instance** repo on GitHub (config/docs; **commit spine** for [cici_journal_ob1_digest.py](../../../scripts/cici_journal_ob1_digest.py)). Canonical pointer replaces `open-brain-xavier` — see [work-cici-history.md](work-cici-history.md) `### 2026-04-10`. |
