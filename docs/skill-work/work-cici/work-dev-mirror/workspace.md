...
7. Apply risk-mitigation template (success criteria, sustainment, deprecation, scope creep) to remaining uncovered territories: `work-politics`, `work-civ-mem`, `work-cici`. Template: `docs/skill-work/work-template/README.md` § Risk-mitigation checklist.
