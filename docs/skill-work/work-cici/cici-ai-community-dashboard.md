...
Use this block as the weekly starting row and keep fields blank until evidence is reviewed:
...
- **First task completed**: A concrete repo, prompt, issue, PR, notebook, or guided artifact exists.  
...
This dashboard may produce coaching notes, handoff drafts, or candidate suggestions, but any durable identity or Record change for Cici must go through Cici's own repo and approval path.
