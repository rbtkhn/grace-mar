...
**Operator catalog era buckets** (shelf / `HNSRC` rows): **ancient** through ~476 AD (fall of Rome in the West); **medieval** through ~1453 AD (fall of Constantinople); **colonial** (early modern, Vol III) through ~1789 AD; **industrial** (Vol IV) through ~1945 AD; **modern** (Vol V) post-1945 — full rule in [OPERATOR-SOURCE-CATALOG.md](research/OPERATOR-SOURCE-CATALOG.md#era-boundaries-operator-rule).
