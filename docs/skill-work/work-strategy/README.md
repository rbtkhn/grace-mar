...
| **[daily-brief-native-international-pass.md](daily-brief-native-international-pass.md)** | **Native-language triangulation** for international load-bearing stories (§1d/§1e + coffee C); one native bullet per jurisdiction alongside wires. |
