...
| **Daily brief output** | One dated file: work-politics snapshot + strategy focus + **§1c** work-jiang hooks + headlines | [daily-brief-template.md](daily-brief-template.md). Snapshot, [daily-brief-focus.md](daily-brief-focus.md), and [daily-brief-jiang-layer.md](daily-brief-jiang-layer.md) § Active hooks are **combined** in the same artifact. Optional **jiang_ref** on work-politics gate candidates links ship to research paths ([wap-candidate-template.md](../work-politics/wap-candidate-template.md)). |
