# Strategy expert — Alexander Mercouris (`alexander-mercouris`)

WORK only; not Record.

**Canonical index:** [strategy-commentator-threads.md](strategy-commentator-threads.md) — **`alexander-mercouris`** lane.
...
- `alexander-mercouris` + **The Duran** format — long episodes, co-hosted multipolar analysis, daily diplomatic tickers.
- `alexander-mercouris` + **realist / restraint-adjacent** voices on Ukraine and great-power geometry — occasional cross-appearances with analysts in **Davis** / **Mearsheimer** orbits (**verify** each ingest’s `thread:`).
...
- `alexander-mercouris` × **mainstream Western/NATO** crisis narratives — contrasts with primary documents and diplomatic history in long-form videos (**do not** treat video title as wire fact).
- `alexander-mercouris` × **single-falsifier demand** — index notes diplomatic “room” stories can be **hard to pin** to one fact — **discipline** vs **Mearsheimer** structural claims or **Ritter** mechanics.
