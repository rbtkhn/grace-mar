# Strategy expert — Jeffrey D. Sachs (`jeffrey-sachs`)
...
- `jeffrey-sachs` + **UN / SDSN / development networks** — metrics, SDGs, systems framing extended to cooperation narratives.
- `jeffrey-sachs` + **multipolar / realist critics of U.S. hegemony** — overlaps in interviews on NATO expansion, China, and relative decline (often paired with **Diesen** on episodes per index note).
...
- `jeffrey-sachs` × **mainstream U.S. foreign-policy establishment** — open letters and faculty debates (e.g. Russia–Ukraine emphasis disputes) — **cite primaries** for who said what.
- `jeffrey-sachs` × **neoliberal shock-therapy legacy** — his later work acknowledges past roles while pushing new paradigms (*A New Foreign Policy*–class framing).
...
- Pull this expert into weave when:
  - **Diesen × Sachs** multipolar episodes, **IMF** growth downgrades, or **UN**-class development hooks sit beside **Hormuz** headlines — **orthogonal** to ORBAT unless evidence couples.
