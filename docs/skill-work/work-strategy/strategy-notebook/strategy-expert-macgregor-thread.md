...
**Source:** Distilled from [`strategy-expert-macgregor-transcript.md`](strategy-expert-macgregor-transcript.md) (what the expert said recently) and relevant knots (where that material was used in strategy work).
