# Strategy expert — `martin-armstrong`
...
**Companion files:** [`strategy-expert-martin-armstrong-transcript.md`](strategy-expert-martin-armstrong-transcript.md) (7-day rolling verbatim) and [`strategy-expert-martin-armstrong-thread.md`](strategy-expert-martin-armstrong-thread.md) (distilled analytical thread).
