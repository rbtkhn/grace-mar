# Mercouris day page — 2026-04-07

WORK only; not Record.

**Expert:** `mercouris` · **Aired:** 2026-04-07 · **Artifact:** refined day page (standalone file under `experts/mercouris/`). Not a `strategy-page` HTML fence in `thread.md` unless you duplicate the same judgment there during EOD compose.
...
- **Canonical video:** [raw-input frontmatter `source_url`](../../raw-input/2026-04-07/duran-mercouris-hormuz-deadline-satellites-oreshnik-2026-04-07.md) — replace TBD watch ID when pinned
