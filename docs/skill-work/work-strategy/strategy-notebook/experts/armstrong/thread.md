...
_Partial month — **machine layer** still empty until `thread:` ingests land in [`strategy-expert-armstrong-transcript.md`](strategy-expert-armstrong-transcript.md); **April** [armstrong-cash-hormuz-digital-dollar-arc](strategy-notebook-knot-2026-04-14-armstrong-cash-hormuz-digital-dollar-arc.md) knot carries the **04-14** cash / Hormuz-mood / digital-dollar synthesis. **Optional 04-17 satellite** (negotiation-trust posts) is threaded per **C + E** below — see knot **Optional satellite** block for when to couple._
