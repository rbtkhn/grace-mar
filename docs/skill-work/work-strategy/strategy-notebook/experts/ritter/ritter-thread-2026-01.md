...
**Companion files:** [`profile.md`](profile.md) and [`transcript.md`](transcript.md) (7-day verbatim). **See also** [`thread.md`](thread.md) (multi-month journal during split) and [`README.md`](README.md).
