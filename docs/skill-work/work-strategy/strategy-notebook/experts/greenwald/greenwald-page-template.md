...
- `Refined day page:` → `greenwald-page-YYYY-MM-DD.md` or `greenwald-page-YYYY-MM-DD-<slug>.md` (one line per refined file).
...
1. Title: `# Greenwald day page — YYYY-MM-DD`. Optional short title in parentheses when multiple pages share the date; filename uses `-<slug>` when split.
