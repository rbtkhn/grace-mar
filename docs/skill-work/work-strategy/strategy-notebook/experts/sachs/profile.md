...
| **Typical pairings** | × `diesen`, × `mearsheimer`, × `mercouris`, × `parsi` |
...
- `sachs` + **multipolar / realist critics of U.S. hegemony** — overlaps in interviews on NATO expansion, China, and relative decline (often paired with **Diesen** on episodes per index note).
...
- `sachs` × **mainstream U.S. foreign-policy establishment** — open letters and faculty debates (e.g. Russia–Ukraine emphasis disputes) — **cite primaries** for who said what.
- `sachs` × **neoliberal shock-therapy legacy** — his later work acknowledges past roles while pushing new paradigms (*A New Foreign Policy*–class framing).
