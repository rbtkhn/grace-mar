...
**Purpose:** Standalone Chronicle / Reflection / Foresight artifact for the `berletic` expert. Not a substitute for full verbatim in [`raw-input/`](../../raw-input/README.md). Distinct from a `strategy-page` HTML fence in [`thread.md`](thread.md) unless you duplicate judgment there during EOD compose.
...
3. `### Reflection` — Berletic-lane arc; keep verification discipline explicit where load-bearing claims sit in commentator tier.
...
- `Refined day page:` → `berletic-page-YYYY-MM-DD.md`.
...
1. Title: `# Berletic day page — YYYY-MM-DD`.
