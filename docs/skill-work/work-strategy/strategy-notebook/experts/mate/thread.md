...
**Source:** Human **narrative journal** (below) + [`strategy-expert-mate-transcript.md`](strategy-expert-mate-transcript.md) (verbatim ingests) + relevant **knot** files (where this expert’s material was used).
