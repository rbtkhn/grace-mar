...
- **Commentator / author threads (index):** [strategy-commentator-threads.md](strategy-commentator-threads.md) â€” **`expert_id`** (first column; inbox: **`thread:<expert_id>`**) â†” **Name** / commentator voice, **grep** tags, typical **`batch-analysis`** pairings
