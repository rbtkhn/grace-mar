...
- **Commentator threads (index):** [strategy-commentator-threads.md](strategy-commentator-threads.md) — **thread_id** ↔ anchor analyst, **grep** tags, typical **`batch-analysis`** pairings
