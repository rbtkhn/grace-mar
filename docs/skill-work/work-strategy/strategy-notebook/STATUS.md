...
| **Last substantive entry** | `2026-04-15` — five-channel wire harvest (§1d Kremlin / §1e Vance / §1g PRC / §1h IRI MFA+IRGC / Rome Leo XIV) woven into **`## 2026-04-15`** Signal/Judgment/Links/Open; **knot** [`kremlin-iri-uranium-dual-register`](chapters/2026-04/knots/strategy-notebook-knot-2026-04-15-kremlin-iri-uranium-dual-register.md) (Synthesis+Thesis: Kremlin-IRI uranium convergence, MFA vs IRGC dual register, Leo-France-UK legitimacy stack); **plus** **Lavrov Beijing × knot-shape E** Judgment corroboration, **Open** **UNSC Hormuz draft vs Islamabad** falsifier pair, **[daily-strategy-inbox.md](daily-strategy-inbox.md)** **`batch-analysis`** (Lavrov×E) — update when you close a real dated or episodic weave |
