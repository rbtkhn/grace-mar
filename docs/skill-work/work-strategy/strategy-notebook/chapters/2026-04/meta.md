...
**Read in one pass:** The chapter opens with **Rome / Islamabad** harvest and **notebook spine** work (04-08–09), then lands the **Islamabad–Hormuz** thesis, **web verification pilot**, and **civ-mem pattern** probe (04-12). **04-13** stacks the **Marandi × Ritter × Mercouris** knot scaffold plus **deep expert ingests** (Davis/Freeman/Mearsheimer, Parsi, Johnson) with explicit **lane splits** (faith vs ORBAT, EU accountability language vs U.S. war powers). **04-14** is the **dense weave day**: six **knot** files under [knot-index.yaml](../../knot-index.yaml), **`steve-jermy`** / **`jeffrey-sachs`** as new indexed threads, **Parsi × Davis** and **Blumenthal × Parsi** batch seams, **PH vi-14 / vi-15** as **corpus overlay** (not a wire substitute for blockade facts), plus **civilizational-strategy-surface** and **case-index** citations folded into Judgment—**and** an explicit **`scott-ritter` × `daniel-davis`** seam (**digest §B** ORBAT vs **X** ultimatum/resumption/macro; **`crosses:scott-ritter+daniel-davis`**) on the same **`## 2026-04-14`** page with a matching **`batch-analysis`** row in [daily-strategy-inbox.md](../../daily-strategy-inbox.md). **04-15** records **Grok vs daily brief** triage ([daily-brief-2026-04-15.md](../../../daily-brief-2026-04-15.md)): IMF delta corrected against AP, labeled **section 1f** overlay, native **section 1g / 1h** hooks — **Judgment** names digest quarantine, **MFA/Tasnim** seam vs **04-12** falsifiers, **`thread:`** carry, and multi-theater **seam-first** rule (expand **Open** as chains land). **04-16:** successor **Grok** digest archived in [daily-brief-2026-04-16.md](../../../daily-brief-2026-04-16.md) §1f + **meta** falsifier gates (§ **Grok 2026-04-16 digest — month falsifiers** below); **§1d–§1h** stubs until watch pass. Same calendar day: operator **`weave`** merges **§1d** (Putin/Kremlin + RIA secondary) and **§1e** (Vance / White House + blockade wires + U.S.–Hungary fact sheet) into **[`days.md`](days.md) `## 2026-04-15`** **Signal / Judgment / Links / Open** with **Links-grade** URLs — **without** pasting the full **04-13/04-14** inbox tail (accumulator stays indexed on **04-14**). **04-17:** **FM Araghchi** **IRI primary** on **X** (**Hormuz** + **Lebanon** ceasefire alignment; **06:45**) + **Davis** QT + **Trump** executive **dual-register** — **expert-thread continuity** without **`thread:`** on the FM line ([daily-brief-2026-04-17.md](../../../daily-brief-2026-04-17.md) **§1h**, [strategy-commentator-threads.md](../../strategy-commentator-threads.md) **Official IRI / MFA voices**). **Same-day weave (`Ritter × Marandi × Davis`):** **`thread:seyed-marandi`** **04-17** **X** **(three** **conditions** **+** **QT** **@araghchi)** **`thread:daniel-davis`** **(Araghchi** **+** **Truth** **Social** **embed)** **`thread:scott-ritter`** **×** **`glenn-diesen`** **(Baltic/NATO** **+** **Islamabad/Hormuz** **carryover** **in** **one** **episode)** — **seam-first** **Judgment** on **[`days.md`](days.md) `## 2026-04-17`** **+** [inbox](../../daily-strategy-inbox.md) **`batch-analysis`** **(three** **planes;** **`crosses:`** **N/A);** **lattice** **[marandi-ritter-mercouris-hormuz-scaffold](knots/strategy-notebook-knot-2026-04-13-marandi-ritter-mercouris-hormuz-scaffold.md).** **Same calendar day — US politics fork:** **Larry Johnson × Robert Barnes** (*Countercurrent*, **`thread:robert-barnes`** + host **`thread:larry-johnson`**) — **White House / Vance / Iran “room”** **hypotheses** **(work-politics)** **beside** **not inside** **the** **FM** **/** **TS** **dual-register** **object** **—** **`crosses:robert-barnes+larry-johnson`**, **Johnson × Ritter** **C-plane** **Judgment** **bullet**, **verbatim** **[excerpt](../../robert-barnes-countercurrent-2026-04-17-verbatim.md)** **(replaceable** **with** **full** **transcript).**
...
**Grep anchor (Ritter×Davis):** `batch-analysis | 2026-04-14 | Ritter × Davis | crosses:scott-ritter+daniel-davis` — inbox row ↔ [`days.md`](days.md) **`## 2026-04-14`** **Signal** / **Judgment** / **Open**.
...
**Expert-thread continuity:** [daily-strategy-inbox.md](../../daily-strategy-inbox.md) § **Expert-thread continuity (2026-04-12 → 2026-04-14)** + `batch-analysis | carry … + PH vi-14/15 + Diesen×Sachs` ( **`crosses:`** include **Parsi × Davis**, **Davis × Jermy**, **Diesen × Sachs**) + **`batch-analysis | 2026-04-14 | Ritter × Davis`** (**`crosses:scott-ritter+daniel-davis`**) → **`## 2026-04-14`** in [`days.md`](days.md) (**Weave** lead bullet + **Diesen × Sachs vs PH vi-14** seam + **Ritter×Davis** Judgment bullet); cross-day join key **`thread:<expert_id>`** per [strategy-commentator-threads.md](../../strategy-commentator-threads.md); new indexed anchors **`steve-jermy`**, **`jeffrey-sachs`** (2026-04-14); **`## 2026-04-15`** = **Grok-vs-brief** triage **Signal** + **Judgment** on digest/native seams, then **`weave`**: brief **§1d/§1e** watch fill folded into **Links** + refreshed **Open** (no new **`thread:`** lines this day).
