...
- **Framing fork (U.S. domestic — Hormuz):** *Just The News* / **John Solomon** (Apr 12) frames a **naval blockade** as a **Trump “card”** to force Iranian compliance; **Chris Martenson**’s quote-tweet offers a **satirical escalation-spiral** read (“blockade to block the blockade”)—**commentariat** disagreement on what **blockade** *means* for **U.S.** audiences **before** **DoD/WH** verification pins **operational** facts.
