...
- **Weave — `alexander-mercouris` (15 Apr 2026) — knot-shape E (great-power + energy lead):** Operator picked **E**: **Lead thesis** = **Russia–China** stack (**Lavrov–Wang–Xi**, Iran crisis elevated), **Hormuz / sanctions / energy attrition** as the **structural** story — **Bloomberg** “blockade about China” line, **TASS** / **Russian Security Council** escalation read, **Pakistan→Saudi** force reporting as **peripheral** alliance motion; **contested** tanker / **AIS** facts stay **tier-split**. **Secondary** = **Islamabad** vs **Washington** bargaining reads; **US** executive / **coalition** liability (**Vance**, war-powers / “who pays” — **tri-mind** **C**). **`tri-mind`** **B→A→C** + **solo A** + **fact-check triage** (WORK); full **tri-mind** prose **chat** unless promoted. **Session fold:** **`days.md`** continuity + **Links** receipts.
...
- **Knot-shape E — great-power / energy spine (lead):** The **same** crisis is **legible first** through **third-party** **energy and alignment**: **China–Russia** foreign-minister / presidential choreography on **Iran**, **Hormuz** pressure as **spillover** on **Asian** crude routes and **sanctions** games, **Bloomberg** editorial read of **blockade → Beijing** leverage, **Russian SC** as **high-authority** military–diplomatic commentary (**ORBAT** numbers **hypothesis-grade** until primary pin) — **before** treating **Islamabad** breakdown or **US** **polling** pain as the **main** story. **Mercouris** programme **anchors** this stack; **tanker** **agnosticism** stays **epistemic discipline**, not **evidence** that the **great-power** read is false.
- **Secondary — Islamabad / uranium mechanism:** **Uranium off-ramp convergence (§1d × §1h):** Kremlin offer (fuel-grade conversion or Russian custody) and IRI MFA stance (enrichment right non-negotiable, level/type "open to discussion") are **compatible in principle** — both reject US unilateral demand posture, both frame enrichment as **manageable** rather than **eliminable**. This is the first **same-day** convergence between a concrete mechanism (Lavrov) and a stated negotiating boundary (Baghaei) since the Islamabad round. **Test:** does Vance "grand bargain" framing accommodate **enrichment continuation with external custody**, or does "affirmative commitment" on nuclear weapons mean **zero enrichment**? If the latter, the Kremlin-IRI convergence is an agreement **between themselves**, not a deal framework the US joins.
- **IRI dual register (MFA vs IRGC):** The same government is running **diplomatic opening** (Baghaei: partial consensus, NPT rights, "open to discussion") and **military escalation** (Abdollahi: block all traffic in three seas) **simultaneously**. This is not incoherence — it is **conditioned branching**: both positions are contingent on US behavior ("seriousness and good faith" / "if blockade continues"). The notebook should track **which register** each wire belongs to; merging into one "Iran says" is the 04-12 false-merge error at institutional scale.
- **Secondary — US / alliance (executive + coalition liability):** **Vance "grand bargain" vs narrow deal:** The shift from **nuclear-only** framing to **nuclear + terrorism + economic** scope is either (a) a genuine expansion that makes a deal **more** possible by adding tradeable dimensions, or (b) a scope escalation that makes agreement **less** possible by adding conditions Iran will reject (especially "terrorism sponsorship" = Hezbollah/proxies = nonstarter for Tehran). Watch which framing dominates next WH readout. **France-UK split from US blockade:** NATO allies announcing a separate **"peaceful multinational mission"** for freedom of navigation is a **new seam** — not previously visible in 04-13/04-14 material. This is a **legitimacy** fracture within the alliance, not just a "refusal to participate." Leo XIV's simultaneous **moral-theological** critique of US omnipotence occupies the same legitimacy space but from a different register (Gospel vs alliance mechanics). **Case echo:** [CASE-0014](../../../case-index.md#case-0014--austro-hungarian-elite-coordination-strain-before-1914) (internal management consuming strategic bandwidth) and [CASE-0007](../../../case-index.md#case-0007--habsburg-imperial-administrative-overcomplexity) (multi-layered coalition coordination cost).
- **Notebook discipline (carry):** **Grok / §1f:** overlay stays **quarantined** until **wire or primary** rows — **no** parallel truth stack beside the filed brief. **`thread:` / `batch-analysis`:** new paste lines route per [strategy-commentator-threads.md](../../strategy-commentator-threads.md); **04-12–04-14** knots still index **polyphony** until pins clear. **Multi-theater:** G7 / Hungary / CPI / Ukraine / Taiwan from digest stay **seam-first** (one **verify** row per chain, not one “busy week” Judgment).
- **LLM digest posture (carry from prior weave):** Prior Judgment stands — Grok overlay stays quarantined in §1f; the **wire harvest** in **Signal** is the corrective: **primary-sourced** channel reads where the digest had **zero attribution** per channel.

### Analogy / tension

- **Broad digest vs filed brief (carry):** Same structural risk; the **wire pass above** is the direct remedy — each Signal bullet is **tagged to a channel** with a **dated URL**, which is what the digest lacked.
- **Kremlin-IRI convergence vs Vance scope:** The **uranium off-ramp** test is the sharpest near-term tension — if Kremlin custody is acceptable to both Tehran and Moscow but not Washington, the "grand bargain" framing becomes a **scope trap** rather than a dealmaker.

### Links

- [daily-brief-2026-04-15.md](../../daily-brief-2026-04-15.md) — §1d · §1e · §1f Grok overlay · §1g/§1h IMF + Hormuz native pointers
- [daily-strategy-inbox.md](../../daily-strategy-inbox.md) — **Wire capture — 2026-04-15** (9 lines + 3 batch-analysis); carry **expert-thread** / **batch-analysis** when this day ingests new **`thread:`** lines; **04-13/04-14** bulk already woven **[2026-04-14](#2026-04-14)**
...
- **Knot-shape E — great-power / energy falsifiers:** Next **Russia–China** public choreography on **Iran** (FM/Presidential readouts) vs **Bloomberg** Hormuz–**China** editorial thesis; **Russian SC** primary (HTML/PDF) for **ORBAT** / escalation lines; **AIS / throughput / insurance** vs **editorial** “about China” claim.
