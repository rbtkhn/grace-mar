...
- **Daniel Davis Deep Dive — Davis × Jermy** (*HORMUZ BLOCKADE NIGHTMARE*): pin canonical **YouTube** URL in [daily-strategy-inbox.md](../../daily-strategy-inbox.md) (replaces **`TBD-canonical-davis-jermy-hormuz-nightmare`** on **both** **`thread:daniel-davis`** and **`thread:steve-jermy`** lines).
