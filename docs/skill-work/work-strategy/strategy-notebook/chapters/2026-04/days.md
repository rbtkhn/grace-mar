...
- [daily-strategy-inbox.md](../../daily-strategy-inbox.md) — **Expert-thread continuity**; **`batch-analysis` (2026-04-14):** **Parsi × Davis**, **Davis × Jermy**, **Diesen × Sachs**, **carry** + **PH vi-14/15** — see **`crosses:`** / **`seam:`** tails in inbox
