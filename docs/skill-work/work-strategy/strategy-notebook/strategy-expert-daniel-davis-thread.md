...
- [strength: medium] **2026-04-17:** **Araghchi** quote-post (Hormuz **open** for commercial traffic for **ceasefire** remainder; coordinated route) + same-calendar-day **Trump** Truth Social thread (**maximalist** terms per Davis embed) — **negotiation-window vs door-shut** read; brief + inbox: [daily-brief-2026-04-17.md](../daily-brief-2026-04-17.md) **§1e/§1h**, [daily-strategy-inbox.md](daily-strategy-inbox.md) — verify:pin-@araghchi+@DanielLDavis1+Truth-Social-URLs.
