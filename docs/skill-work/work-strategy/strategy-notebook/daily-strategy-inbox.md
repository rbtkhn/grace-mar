...
| **2026-04-14** | PH **vi-14** × **vi-15** ingest above; **`Parsi × Davis`** weave (**EU naming** vs **U.S. war-powers** — inbox `batch-analysis` after the two **`thread:`** paste lines near **Folded**) | `glenn-diesen`, `jiang-xueqin`; **`crosses:trita-parsi+daniel-davis`** (**orthogonal** to PH — different Judgment fold) |

`batch-analysis | 2026-04-14 | carry 04-12–04-13 expert lanes + PH vi-14/15 | **Continuity spine:** **Hormuz / Islamabad / alliance geometry** threads (`scott-ritter`, `john-mearsheimer`, `alexander-mercouris`, `seyed-marandi`, `trita-parsi`, `robert-pape`, `daniel-davis`, `larry-johnson`, `charles-freeman`) stay the **mechanics + room + trap** stack; **PH vi-14/vi-15** (`glenn-diesen`, `jiang-xueqin`) add **petrodollar / eschatology** overlays—**do not** collapse into one “civilizational verdict.” **New this cycle (wires / social):** **Italy** as **European hinge** (defense-diplomatic + Trump–Pope friction) + **IRI presidential roster** naming Italy beside others—**treat as coalition narrative + verify tier**, not automatic merge with **04-13** **Marandi×Mercouris×Ritter** Judgment until primaries pin. **Rome plane** (`ROME`, **Pontifex** / Algeria journey): **parallel legitimacy seam** vs **Hormuz ORBAT**—same **tier split** as 04-13 **Grand Mosque** fold. **Weak bridge:** “isolation / beg counts” memes = **hypothesis-grade** unless elevated with **dated** **§1d/§1e**-class cites—**do not** stand in for **`thread:`** experts.`
