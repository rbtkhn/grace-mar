...
**Weave rhythm (two layers):** **(1) Day-end / calendar boundary** — the **timestamp** determines **which** `## YYYY-MM-DD` page receives the **end-of-day** weave (e.g. **`dream`**, or the first maintenance pass after local midnight): that is when **stale scratch** must land on the **correct dated** block and the **accumulator line** catches up to the clock if needed. **(2) Intra-day manual weave** — the operator may direct a **weave at any time** (e.g. **`weave`**, **`fold`** (legacy), explicit instruction) to synthesize scratch into **today’s** `days.md` **for cognitive cadence** and clearer analysis; that **does not** replace the clock and **does not** bump **`Accumulator for`** to a new day. Same synthesis rules apply (Signal / Judgment / Links / Open — not a raw dump). **Which lines you weave shapes section weighting** on the page — promotion, not parity across headings: [STRATEGY-NOTEBOOK-ARCHITECTURE.md](STRATEGY-NOTEBOOK-ARCHITECTURE.md) § *Weave choice and section weighting*. **Optional:** log weaves for learning over time — [FOLD-LEARNING.md](FOLD-LEARNING.md) (`scripts/log_strategy_fold.py`).
...
**Weave:** Inbox scratch merges into **`chapters/YYYY-MM/days.md`** as one **`## YYYY-MM-DD`** block (Signal / Judgment / Links / Open — synthesize, not a raw dump) when **`dream`** runs (**day-end**, timestamp-aligned), when the operator **manually** directs a weave (**intra-day cadence**), or on equivalent explicit instruction. **Assistants:** do **not** merge into `days.md` on strategy-ingest alone; keep captures **here** until **`dream`**, **`weave`**, **`fold`** (legacy), or explicit instruction. Full rules: [STRATEGY-NOTEBOOK-ARCHITECTURE.md](STRATEGY-NOTEBOOK-ARCHITECTURE.md) § *Daily strategy inbox*; **`dream`**: [.cursor/skills/dream/SKILL.md](../../../../.cursor/skills/dream/SKILL.md).
...
`X | cold: Daniel Davis (@DanielLDavis1) — where is Congress as U.S. in “full scale war” with Iran; Trump escalated to **naval blockade** as “overt act of war”; lawmakers abdicate duty while paid; **vote out every incumbent** November frame // hook: extends **`daniel-davis`** expert thread + **war powers** lane vs same-day **Roll Call** §2c bundle; legal characterization = analyst thesis until statute primaries | https://x.com/DanielLDavis1/status/TBD-pin-exact | verify:operator-screenshot+pin-exact-status-URL | thread:daniel-davis`

`X | cold: Trita Parsi (@tparsi) QT **Kaja Kallas** (@kajakallas) — contrasts Kallas wording: **“Russia’s war of aggression against Ukraine”** vs passive **“the war in the Middle East”** (Iran/US–Israel) in same crisis frame; charges **double standard** on aggressor/victim/crime language // hook: extends **`trita-parsi`** **framing / international-law rhetoric** thread (04-12 Lebanon–nuclear “mask”; 04-13 Breaking Points venue); pin **both** status URLs for quote-grade | https://x.com/tparsi/status/TBD-pin-exact | verify:operator-screenshot+pin-tparsi+pin-kallas-quoted | thread:trita-parsi`

`batch-analysis | 2026-04-14 | Parsi × Davis | **Tension-first:** **`trita-parsi`** = **EU / Western speech-act** plane — who gets **named** aggressor vs who gets **geography-only** “Middle East war” grammar (**Kallas** QT); **`daniel-davis`** = **U.S. domestic** plane — **Congress** missing while executive frames **Iran** escalation / **blockade**; **vote-out incumbents** mobilization. **Do not** merge into one “accountability story” without seams: **Brussels framing** ≠ **House/Senate** votes until primaries pin. *Weak bridge:* both probe **accountability language** — **international law breakdown** rhetoric vs **constitutional duty / war powers** rhetoric — same news week, **different institutions**; **Mercouris** layer = diplomatic naming; **Barnes** layer = who pays at the ballot box; **Mearsheimer** layer = whether rhetoric tracks **binding** constraints. | crosses:trita-parsi+daniel-davis`

`YT | cold: Scott Ritter — **Ritter's Rant 085: The Blockade** — **blockade** vs **quarantine** semantics (act-of-war frame); **U.S. hull count** (~**13** in-show) vs **Indian Ocean** geography; **Kennedy** Cuban **quarantine** analogy; **missile** **no-go** off Iran; **China / Russia / India** “**exceptions**” thesis; **time**, **floating storage**, **land routes**; **domestic** **Trump** audience + **predicted** “**deal / they beg**” **close** // hook: extends **`scott-ritter`** **sea-control / porous blockade** lane (stacks **04-13** Judging Freedom × **Davis Deep Dive** **Ritter** rows); **hull tallies** + **China non-interdiction** **strong** **form** = **analyst** until wire tier | https://www.youtube.com/watch?v=TBD-canonical-085 | verify:pin-exact-episode-URL+wire-AP-2026-04-13-defense-official-hull-tally-vs-Ritter-13+wire-Reuters-2026-04-13-China-MFA-Guo-WangYi-restraint+separate-primary-if-citing-China-non-interdiction-carveout | thread:scott-ritter`

`X | cold: Pedro Sánchez (@sanchezcastejon) — **Xi** summit (2026-04-14): **Spain–China** bond “strengthened”; **EU–China** framed as **trust, dialogue, stability**; **multipolar order** via **respect and pragmatism** (handshake + flags photo) // hook: **EU** **hedge** / **BRI–Atlantic** **narrative** lane **vs** same-week **Hormuz** **blockade** + **China MFA** **restraint** wires — **do not** merge **Pacific–Atlantic** **connectivity** **speech** with **Gulf** **coercion** **facts** without primaries; **no** **`thread:`** (not indexed expert — government **X**) | https://x.com/sanchezcastejon/status/TBD-pin-exact | verify:pin-exact-status-URL+official-readout-if-separate+wire-Reuters-China-MFA-Hormuz-same-week+EU-commission-trade-screening-if-claiming-deals`

`batch-analysis | 2026-04-14 | Spain × China | **Tension-first:** **Sánchez–Xi** **summit** = **EU–China** **bridge** + **multipolar** **pragmatism** **rhetoric** (photo diplomacy, **strategic** **autonomy** **tone**). **Same news week:** **Hormuz** **blockade** / **CENTCOM** **enforcement** + **Reuters** **Guo**/**Wang** **Yi** **restraint**/**interests** lines = **Gulf** **crisis** + **energy** **risk** **plane**. **Do not** fold into one **“China** **strategy”** Judgment: **Madrid** **summitry** ≠ **Beijing** **Gulf** **posture** unless **FDI**/**sanctions**/**NATO**/**bilateral** **US** primaries **couple** the stories. *Weak bridge:* both weeks surface **multipolar** **language** — **different** **seams** (**Iberian**/**EU** **institutional** vs **maritime** **coercion**). | seam:sanchez-xi-summit+hormuz-brief-same-week`

`YT | cold: Daniel Davis — **Daniel Davis Deep Dive** (*Navy Combat Vet: HORMUZ BLOCKADE NIGHTMARE*, w/ **Commodore Steve Jermy**) — **Trump** endgame vague on success metrics (clip); **blockade** as **mid-ceasefire** **brinkmanship**; **~$92** oil / **Thursday** talks / **Apr 22** ceasefire clock; **Rich Star** Chinese tanker **let through** as **political** signal; **JD Vance** “we have the cards” clip vs **Jermy** pushback setup; **Marandi** clip **existential war** // hook: extends **`daniel-davis`** **Deep Dive** lane + **Hormuz** **bargaining** frame | https://www.youtube.com/watch?v=etxmqrdm3V0 | verify:yt-etxmqrdm3V0+operator-transcript+membrane:pair | thread:daniel-davis`
...
`batch-analysis | 2026-04-14 | Davis × Jermy | **Tension-first:** **`daniel-davis`** = **executive** / **negotiation clock** / **who has leverage** rhetoric (**Vance**, **Trump** clips, **tanker** **political** **pass**). **`steve-jermy`** = **global energy–logistics** **system** (**closure duration** → **GDP** **recovery** **lag**, **diesel** **cascade**, **semis**/food). **Do not** merge: **ORBAT**/**interdiction** **facts** ≠ **slide-model** **percentages** without **tier-A** **verify**. *Weak bridge:* both **stress** **time** — **ceasefire**/**talks** **calendar** vs **macro** **“baked in”** — **Mercouris** = **diplomatic** **surface**; **Mearsheimer** = **whether** **leverage** talk matches **structure**; **Barnes** = **who pays** at **election**/**pump**. | crosses:daniel-davis+steve-jermy`

`YT | cold: Glenn Diesen — **Jeffrey Sachs**: **Trump’s Naval Blockade of the Strait of Hormuz** (2026-04-14) — host frame: **talks failed** / **maximal** U.S. terms read as **capitulation**; **U.S. naval blockade** **before** ceasefire expires; **rationality** probe — war rationale weak (**nuclear** / **mullah** deterrence / **regime-change** air-war fantasy); **Iran** long-war **Hormuz** response as predictable **existential** deterrence; **allied assumption** failures (**China** semis, **Russia** sanctions, “**unprovoked**”) + **Washington** administrative **incompetence** (“what is real”) // hook: **`glenn-diesen`** **multipolar** + **epistemic** lane; same episode as **`jeffrey-sachs`** | https://www.youtube.com/watch?v=S6mlCuvKKIQ | verify:yt-S6mlCuvKKIQ+operator-transcript+membrane:pair | thread:glenn-diesen`

`YT | cold: Jeffrey Sachs — same episode (**Glenn Diesen** program) — **non-linear chaos** (ceasefire ↔ **Beirut** escalation ↔ **Vance** marathon talks; **Iran 10-point** basis **missing** in-room); **blockade-of-blockade** “first”; **Israel** as **anti-ceasefire** **partner** vs **Lebanon** in/out of ceasefire (**Pakistan**/**Iran** vs **Israel**/**US**); **Trump** **bully/bluster** / “**all the cards**” vs **Iran** not acceding; **deinstitutionalized** decision-making (**ExCom**/Cuban Missile Crisis vs **Trump + yes-men**); **NYT** **undisputed** **Mossad**/**Netanyahu** pitch-to-Trump **room** account; **Truth Social** / **mental stability** thesis (**hypothesis** — **tier-C**); **Congress** **paralyzed**; **Biden**/**Wilson** **incapacity** parallel; **amateur** **trade** team (**Lutnick**/**Navarro**) ↔ **Iran** policy; **multipolar** denial + **hegemon** **flailing** // hook: new **`jeffrey-sachs`** **institutions + macro decline** thread | https://www.youtube.com/watch?v=S6mlCuvKKIQ | verify:same-URL-as-Diesen-line+operator-transcript+hypothesis-grade-psych+wire-if-citing-NYT-war-room | thread:jeffrey-sachs`

`batch-analysis | 2026-04-14 | Diesen × Sachs | **Tension-first:** **`glenn-diesen`** = **host** **pattern** recognition (**bad assumptions**, **administrative** incompetence, **what is real**). **`jeffrey-sachs`** = **DC institutional** **collapse** + **personalized** executive + **relative-decline** backdrop — **not** a substitute for **`john-mearsheimer`** **offensive-realism** **ORBAT** without relabeling mechanisms. **Do not** merge **Sachs** **capacity/health** **hypotheses** with **wire** **fact** rows; **NYT** **war-origin** **room** story = **journalistic** until on-record **primary**. *Weak bridge:* both **stress** **non-clever chaos** vs **deep strategy** — **Mercouris** = **legitimacy** **choreography**; **Mearsheimer** = **incentive** **structure**; **Barnes** = **who can check** the **executive** (**Congress** vs **job** **fear**). | crosses:glenn-diesen+jeffrey-sachs`
...
`batch-analysis | 2026-04-14 | Blumenthal × Parsi | **Tension-first:** **`max-blumenthal`** = **alt-media** **donor/admin** **adjacency** and **backchannel** **elites** frame (**Clinton** + **Adelson** + **Trump team** **encouragement** claims — **hypothesis-grade**). **`trita-parsi`** = **Beltway-facing** **Lebanon vs nuclear** **room** test + **EU** **labeling** (**Kallas** **QT**, 04-14). **Do not** merge: **network-access** **story** ≠ **what Beirut/Tehran tables** show without **room** primaries; **different** **epistemic** **chains**. *Weak bridge:* both keep **Lebanon** **salient** beside **Iran** week — **Mercouris** = **who** **sounds** **legitimate**; **Barnes** = **who pays** **electoral**; **Mearsheimer** = **whether** **rhetoric** tracks **power**. | crosses:max-blumenthal+trita-parsi`
...
- **Weave:** Inbox → `days.md` at **`dream`** or when you **explicitly** direct (**`weave`** / **`fold`** (legacy); not on ingest alone).
...
| **2026-04-14** | PH **vi-14** × **vi-15** ingest above; **`Parsi × Davis`** weave (**EU naming** vs **U.S. war-powers**); **`Diesen × Sachs`** Hormuz blockade (two **`thread:`** lines + **`batch-analysis`** — same **Folded**-adjacent block as **Davis × Jermy**) | `glenn-diesen` (**two** sources: **vi-14** lecture + **Diesen×Sachs** episode), `jiang-xueqin`, `jeffrey-sachs`; **`crosses:trita-parsi+daniel-davis`**, **`crosses:glenn-diesen+jeffrey-sachs`** — **Diesen×Sachs** **orthogonal** to **vi-14** **PH** fold |
