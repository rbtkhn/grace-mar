...
**Legacy tri-voice journal + `strategy-page` blocks:** [`../iri-institutional/thread.md`](../iri-institutional/thread.md) — subsection **### Voice — Araghchi (FM)** under **`## YYYY-MM`** (inbound links preserved).

**Profile:** [`profile.md`](profile.md) — **official** / FM lane (**not** a commentator **`expert`**).
