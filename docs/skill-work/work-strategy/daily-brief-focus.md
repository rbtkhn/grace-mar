...
- **Civilizational / geopolitics operator ledger:** [civilizational-strategy-surface.md](civilizational-strategy-surface.md) — long-horizon CORE + heuristics + `WS–MEM` entries (WORK-only; gate only when promoting to Record or milestones).
...
- **Putin — last 48h:** Good morning fills **§1d** in the generated daily brief per [daily-brief-putin-watch.md](daily-brief-putin-watch.md) (web scan + citations).
