...
- **Xi — Sheikh Khaled bin Mohamed bin Zayed (14 Apr, Beijing):** **Four-point** proposal on Gulf/Middle East stability: **peaceful coexistence** and a **common, comprehensive, cooperative and sustainable** regional security architecture; **national sovereignty** (territorial integrity, safety of personnel/facilities); **international rule of law** / UN-centered system / UN Charter; **development and security** coordinated — China offers **modernization** opportunities to regional states. Crown Prince: UAE values China’s constructive role; **ceasefire**, regional peace, **international shipping security**, **energy security**. [Xinhua](https://english.news.cn/20260414/020925990d2a4f4486ae77e3be4f688f/c.html) · [PRC MFA (ZH page)](https://www.mfa.gov.cn/web/wjdt_674879/gjldrhd_674881/202604/t20260414_11891401.shtml)
- **Guo Jiakun (14 Apr) — USCENTCOM “blockade”:** China says the move **aggravates confrontation**, **undermines the fragile ceasefire**, and **jeopardizes safe passage** through Hormuz; urges honoring ceasefire and **peace talks**. [PRC MFA (EN transcript)](https://www.fmprc.gov.cn/eng/xw/fyrbt/202604/t20260414_11891740.html)
- **Guo (14 Apr) — alleged arms to Iran and 50% tariff threat:** military-export reports **“purely fabricated”**; **if the U.S. goes ahead with tariff hikes on China on that basis, China will respond with countermeasures** (transcript wording). Same file as above. **Note:** Mercouris **“rare earths”** detail is **not** in this MFA excerpt — add **Mandarin-primary** scrape if industrial countermeasures must be quoted precisely.
...
**Watch pass (supersedes tri-mind stub — IRI primaries still to pin):**

- **Araghchi — Lavrov (14 Apr):** First-pass **substance** appears in **Russian MFA** text (§1d): Araghchi briefed on **Islamabad (11 Apr)**; Russian side characterizes Iran as seeking **root-causes** diplomacy. **Pull** matching **en.mfa.ir** / **IRNA** / **Tasnim** dated lines for **Tehran-native** wording on the same call — not yet pasted here.
...
until actor-channel passes in §1d-§1h are filled.

### Top developments

#### Development 1 — Hormuz blockade has moved from threat framing to active operations framing

##### What happened

Multiple sources in §2 and §2a describe a live U.S. blockade frame in Hormuz
...
#### Development 2 — IMF downgrade signal is present, but quantified macro transmission remains unverified in-file
...
**Seam / tension:** This brief has no primary IMF tables or quoted release text; quantified deltas remain `[UNVERIFIED — no primary found]` in-file.

#### Development 3 — U.S. domestic political risk around Iran has intensified in media-congress channels
...
§1d-§1h are filled with actor-primary material.
...
- Actor-primary updates in §1d-§1h for Russia, VP channel, PRC, and IRI
