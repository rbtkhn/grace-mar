...
_Scan refreshed **2026-04-02** (coffee menu **C**). Rolling window **~48h** through **~18:30** UTC. Bullets + URLs — operator WORK, not Record. Same-day Kremlin feed: [president / news](http://en.kremlin.ru/events/president)._

- **2026-04-02 — Greetings on Russia–Belarus Unity of Peoples Day.** Kremlin-published message; integration framing (Eurasian space). Primary: [Kremlin EN — Greetings on Russia and Belarus Unity Day](http://en.kremlin.ru/events/president/news/79451). Wire (RU): [RIA — Putin on Russia–Belarus union as driver of integration](https://ria.ru/20260402/putin-2084685044.html).
- **2026-04-02 — Meeting with Egyptian Foreign Minister Badr Abdelatty (Kremlin).** Middle East / bilateral agenda; Peskov readout that Middle East events would be discussed. Wire (RU): [RIA — Putin and Egypt FM to discuss Middle East, per Peskov](https://ria.ru/20260402/obsuzhdeniya-2084739102.html); Egypt FM on **Russia–Africa summit** (Oct 2026) and regional hopes: [RIA — Egypt confirms summit participation](https://ria.ru/20260402/sammit-2084767069.html).
- **2026-04-02 — Telephone conversation with Saudi Crown Prince and PM Mohammed bin Salman Al Saud.** Announced same day (~15:35 Moscow time per schedule reporting); topics in wire coverage include **Middle East / Iran crisis** and **energy security**. Announcement (RU): [RIA — Ushakov on Putin–MBS call](https://ria.ru/20260402/putin-2084761026.html); readout (RU): [RIA — Putin and MBS discussed Iran crisis](https://ria.ru/20260402/putin-2084799583.html). Prefer [Kremlin EN events by date](http://en.kremlin.ru/events/president/news) for the canonical **news/** page when it is listed for this date.
