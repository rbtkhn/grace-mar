...
**Follow-up:** Operator skills + `docs/operator-skills.md` now surface §8 / `america-first-ky` for `weekly-brief-run`, `wap-pulse`, and `operator-cadence` related-file discovery.
