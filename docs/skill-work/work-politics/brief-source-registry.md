...
| **Polymarket KY-04** (primary + GE) | live external | [polling-and-markets.md](polling-and-markets.md) | Implied odds vs horserace; check **volume** | daily (hey) | 2026-04-03 | watch | Prices not Record truth; cite page prices, not AI “Market Context” blurbs |
