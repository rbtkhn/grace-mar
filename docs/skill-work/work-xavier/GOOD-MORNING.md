# GOOD-MORNING — Xavier instance (`fork_id`: xavier, **her repo**)
...
| 10 | Add one line to **her** `users/xavier/session-log.md`: date + “Session 0 complete; first good morning tasks 1–10 done.” |
