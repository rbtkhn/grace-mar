...
*Filename `GOOD-MORNING.md` is legacy; grace-mar operator activation is **coffee** (work-start vs **signing-off** intent — same **A–E** menu; **C — Compass** includes work-strategy-rome), with legacy **hey** still accepted — mirror the current vocabulary in chat.*
