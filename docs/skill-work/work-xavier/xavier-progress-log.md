...
**Audience:** Operator (employer / advisor). **Purpose:** **Qualitative** notes on **how Xavier works** — tools, bursts of activity, coaching hooks — alongside [xavier-work-profile.md](xavier-work-profile.md) (skills matrix) and [work-xavier-history.md](work-xavier-history.md) (territory milestones + dated evidence pointers).
...
| Date | Note |
|------|------|
| 2026-04-26 | Cici **RTF ingest** — source-priority session ([cici-rtf-session-ingest-2026-04-26-productive-feature-source-priority.md](evidence/cici-rtf-session-ingest-2026-04-26-productive-feature-source-priority.md)); progress log index + burst; [work-xavier-history.md](work-xavier-history.md); [INDEX.md](INDEX.md). |
...
| 2026-04-15 | **brew_mind** GitHub sync + **Cici** no-change snapshot ([brewmind-site-github-sync-2026-04-15.md](evidence/brewmind-site-github-sync-2026-04-15.md)); progress log index + burst; [work-xavier-history.md](work-xavier-history.md); [INDEX.md](INDEX.md). |
...
| 2026-04-13 | Cici **Claude Code personalization PDF** ([cici-personalization-pdf-ingest-2026-04-13.md](evidence/cici-personalization-pdf-ingest-2026-04-13.md) + `.pdf`); progress log index + [work-xavier-history.md](work-xavier-history.md). |
