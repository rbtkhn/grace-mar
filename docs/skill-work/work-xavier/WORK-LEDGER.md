...
- Framing-audit and multi-frame registries are **partial** (see [work-template/MAPPING.md](../work-template/MAPPING.md) work-xavier subsection when present).
...
Prefer [work-xavier-history.md](work-xavier-history.md) for dated milestones and [SYNC-DAILY.md](SYNC-DAILY.md) for the daily snapshot.
