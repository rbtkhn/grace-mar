...
- **companion-self** / **companion-xavier** — **Always hyphenated** when naming a **system or instance** (template repo, named fork, intelligence-system deployment). **companion-self** = upstream template; **companion-xavier** = Xavier’s sovereign instance. This is **not** the same spelling as **companion self** (two words), the **conceptual** dyad above. See [glossary.md](docs/glossary.md).
- **companion-self** / **companion-xavier** — **Always hyphenated** when naming a **system or instance** (template repo, named fork, intelligence-system deployment). **companion-self** = upstream template; **companion-xavier** = Xavier’s sovereign instance. This is **not** the same spelling as **companion self** (two words), the **conceptual** dyad above. See [glossary.md](docs/glossary.md).
