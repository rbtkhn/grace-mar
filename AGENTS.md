...
**`coffee` menu:** **A**, **B**, **C**, **D1–D5**, **E**. **D1–D5** = **Conductor** (symphony / strategy coffee cadence): **D1 Toscanini**, **D2 Furtwängler**, **D3 Bernstein**, **D4 Karajan**, **D5 Kleiber**. Continuity and recommendation can be mentioned in prose, but the letters themselves stay fixed. **E** = system choice, including **self-skill-write** and PRP. See `.cursor/skills/coffee/SKILL.md`, [CONDUCTOR-PASS.md](docs/skill-work/work-coffee/CONDUCTOR-PASS.md), and [COFFEE-CADENCE-CONDUCTOR-PROTOCOL.md](docs/skill-work/work-strategy/strategy-notebook/COFFEE-CADENCE-CONDUCTOR-PROTOCOL.md).
