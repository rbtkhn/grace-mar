...
| **Generate today’s daily brief file** | `generate_work_politics_daily_brief.py` — see [work-strategy README](../../../docs/skill-work/work-strategy/README.md); **coffee** menu **A — Today** — not `strategy` Step 1 |
