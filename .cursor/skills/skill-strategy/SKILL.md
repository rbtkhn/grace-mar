...
| **Fold** | **`dream`** fold, or **explicit** operator direction to extend **`days.md`** | Active month `chapters/YYYY-MM/days.md` under **`## YYYY-MM-DD`** | **Daily block fragment** per § *Daily block extension* and [Daily entry template](../../../docs/skill-work/work-strategy/strategy-notebook/STRATEGY-NOTEBOOK-ARCHITECTURE.md#daily-entry-template) in STRATEGY-NOTEBOOK-ARCHITECTURE — **academic** prose. **Do not** append or merge into `days.md` until Fold unless explicitly directed. |
