...
- **Metaphor vs repo work:** Language that **sounds** like a notebook heading or **lane metaphor** (e.g. resonance, helix, thread) may be **Think / probe**, not a request to **audit** files or **change** templates — unless the operator uses **implement**, **DOCSYNC**, **Weave**, **`weave`**, or **EXECUTE** (see [operator-style.mdc](../../../.cursor/rules/operator-style.mdc) lanes).
