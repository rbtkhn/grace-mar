...
- **Think:** Output **Perceiver + hooks + checklist table** in chat; **no** gate merge, **no** `self.md` / prompt edits.
- **Ship:** Only when the operator names **EXECUTE** / **DOCSYNC** and specific paths (e.g. new transcript file, INDEX row, stub update).
...
5. Remind operator to **append** [INDEX.md](../../../research/external/work-strategy/analyst-corpus/INDEX.md) row (`theodore-postol`, **digest_one_line**, **verify_focus**).
