...
- Operator says **`conductor`**, a **master** name, **`coffee`** hub **E**, or (legacy) **`D` +** fragment — the **`coffee`** hub **never** lists five Symphony masters as separate lines (**hub E** is the Conductor slot).
