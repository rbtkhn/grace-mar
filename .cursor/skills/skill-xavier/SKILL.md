---
name: skill-xavier
preferred_activation: skill-xavier
description: "Xavier OB1 / Cici learning rhythm and day journal — distilled from xavier-journal. Two modes: (A) mentor in grace-mar with GitHub digest + inbox + optional full-day synthesis; (B) Xavier in Cici repo with the same section template, manual commit spine, governed-state checks. Triggers: skill-xavier, xavier journal, Cici day, OB1 learning log."
---

# skill-xavier — Xavier journal baseline
...
**Canonical prose + automation spec (grace-mar):** [docs/skill-work/work-xavier/xavier-journal/README.md](../../../docs/skill-work/work-xavier/xavier-journal/README.md) · [SYNTHESIS-SOURCES.md](../../../docs/skill-work/work-xavier/xavier-journal/SYNTHESIS-SOURCES.md).
...
- **“In Xavier’s OB1 / Cici / BrewMind world, I am observing, coaching, or logging …”** → this skill (and **xavier-journal** paths in grace-mar if Mode A).
- **“In grace-mar’s own work-dev / integration / harness, I am building …”** → [dev-journal](../../../docs/skill-work/work-dev/dev-journal/README.md), not this skill.
...
|-------|---------|---------------------|---------------|
| **L1** | Git signal — what shipped | [xavier_journal_ob1_digest.py](../../../scripts/xavier_journal_ob1_digest.py) pulls **Cici** `main` for the calendar window | Paste commits or link to GitHub compare for that day |
| **L2** | Operator / same-day context | `xavier-journal/inbox/`, optional `--full-day-synthesis` (strategy-notebook + session-transcript per [SYNTHESIS-SOURCES](../../../docs/skill-work/work-xavier/xavier-journal/SYNTHESIS-SOURCES.md)) | Short notes in-repo (e.g. `docs/personal/` or a `journal/` folder **you** create — keep **no secrets**) |
...
1. **Optional rolling capture** during the day: append to [daily-xavier-journal-inbox.md](../../../docs/skill-work/work-xavier/xavier-journal/daily-xavier-journal-inbox.md). At **`dream`**, fold into `inbox/YYYY-MM-DD.md` (see [inbox README](../../../docs/skill-work/work-xavier/xavier-journal/inbox/README.md)).
2. **Generate or refresh the day file** from repo root (set **`TZ`** to your local calendar day):
   ...
   ```
   Git-only: omit `--full-day-synthesis` or use `--no-inbox`. See [xavier-journal README](../../../docs/skill-work/work-xavier/xavier-journal/README.md) for flags, `GITHUB_TOKEN`, catch-up, and `--force`.
...
**Recursive learning (optional):** Strong days → one line in [work-xavier-history.md](../../../docs/skill-work/work-xavier/work-xavier-history.md); occasional [harvest](../harvest/SKILL.md) over recent `xavier-journal/*.md`.
...
1. **Pick calendar day** and create or edit a markdown file where she keeps learning notes (Cici is config/docs–centric; there is no built-in `xavier-journal/` mirror unless she adds one — e.g. `docs/journal/YYYY-MM-DD.md` or personal paths under `docs/personal/` per her README).
...
- **Companion / operator roles:** Mentor uses grace-mar **work-xavier**; Xavier uses **Cici** for instance truth-in-git; keep leakage rules in [LEAKAGE-CHECKLIST.md](../../../docs/skill-work/work-xavier/LEAKAGE-CHECKLIST.md) in mind when pasting paths across repos.
...
3. Optionally add one line to **Cici `CLAUDE.md`**: e.g. “Daily learning log: follow `.cursor/skills/skill-xavier/SKILL.md` (Mode B).”
...
| Topic | Link |
|--------|------|
| Full journal spec | [xavier-journal README](../../../docs/skill-work/work-xavier/xavier-journal/README.md) |
