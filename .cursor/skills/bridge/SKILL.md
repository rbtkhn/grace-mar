...
| **Quick check before stepping away** | **`coffee`** + signing-off intent (`--mode closeout` / handoff Step 1) | Lightweight status; no commit/push, no transfer prompt; same fixed **A–D** hub as work-start |
