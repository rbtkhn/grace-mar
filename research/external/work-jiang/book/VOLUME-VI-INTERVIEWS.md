...
**Corpus:** `series: interviews` in `metadata/sources.yaml`; `source_id` `vi-01` …; curated files `lectures/interviews-NN-*.md` (wired in `build_source_registry.py`, `validate_work_jiang.py`, ASR normalizer).  
...
|-------|-------------|----------------------|
| Interviews #1–#2 | `vi-01` … `vi-02` | `lectures/interviews-NN-*.md` |
