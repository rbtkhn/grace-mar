...
The **Preface** explains why this book exists and how it treats evidence. This **Introduction** is the map: what claim the book advances, how **Part I** (twelve chapters) follows the **twelve Geo-Strategy lectures** in order, how each chapter ends with **registry-backed predictions**, and how **Part II** (after Chapter 12) analyzes those predictions as a set.
...
### Part I — One chapter per lecture (Chapters 1–12)

**Chapters 1–12** track **Geo-Strategy #1 through #12** in the same order as the classroom series. This volume is therefore **not** a “normal” survey history that hides the seams of teaching; it keeps Jiang’s **session-by-session arc**, examples, and cumulative argument. Chapter titles match the lecture titles (see the curated transcript files and canonical YouTube links in each chapter’s evidence pack).

Rough **shape within the series**: early lectures build **asymmetry, religion, empire, and election** threads; mid-to-late lectures turn toward **case studies, scenarios, Russia, America, and method**—including the **finale** on psychohistory and imagining the future. Exposition and analysis **interleave** as they did in class.
...
- If you want **speed**, read **chapter 1** and **chapter 12** (Part I bookends), then read **Part II** for how predictions are scored, then skim the appendices.
- If you want **depth**, read **in lecture order** (Part I, chapters 1–12), note the prediction box at each chapter end, then read **Part II**, then use appendices as reference tools rather than a verdict.
