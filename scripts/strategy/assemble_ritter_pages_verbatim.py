#!/usr/bin/env python3
"""Rewrite ritter-page-*.md: ~80% expert verbatim (Chronicle) + ~20% WORK (Reflection/Foresight).
...
def _mode_para(mode: str) -> str:
    ...
    if mode == "C":
        return (
            ...
            "rhetoric preserved in Chronicle; corroborate operational claims before wire-style use."
        )
    return (
