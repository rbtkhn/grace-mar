# Historical expert context — `jiang-xueqin` — `2026-03`
...
```text
historical-expert-context | jiang-xueqin | stance=[strength: low] **Repeat:** PH channel hub — verify any calendar claim against lecture index before Links merge. | provenance=high:0,medium:0,low:1
```
