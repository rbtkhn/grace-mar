# Historical expert context — `jacques-baud`

WORK only; not Record.
Source thread: `docs/skill-work/work-strategy/strategy-notebook/strategy-expert-jacques-baud-thread.md`
...
```text
historical-expert-context | jacques-baud | stance=[strength: low] **Identity anchor:** The Postil + IHL reference instrument (Seed). || [strength: low] **Secondary pointer:** Transcend TMS reprint (Dec 2025 URL in profile) — **not** a February 2026 dated primary; tier-C context only. || [strength: low] **Repeat anchor:** The Postil hub — scope unchanged. | tensions=[strength: low] **Note:** Use beside **`scott-ritter`** / European mandate seams when **`batch-analysis`** crosses alliance narrative vs evidential limits. | shifts=[strength: low] **Repeat anchor:** The Postil hub — scope unchanged. | provenance=high:0,medium:0,low:5
```
