# Historical expert context — `jacques-baud` — `2026-01`
...
```text
historical-expert-context | jacques-baud | stance=[strength: low] **Identity anchor:** The Postil + IHL reference instrument (Seed). | provenance=high:0,medium:0,low:1
```
