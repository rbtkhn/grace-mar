# Historical expert context — `jacques-baud` — `2026-02`
...
```text
historical-expert-context | jacques-baud | stance=[strength: low] **Secondary pointer:** Transcend TMS reprint (Dec 2025 URL in profile) — **not** a February 2026 dated primary; tier-C context only. | provenance=high:0,medium:0,low:1
```
