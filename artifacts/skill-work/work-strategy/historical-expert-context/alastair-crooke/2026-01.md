# Historical expert context — `alastair-crooke` — `2026-01`
...
```text
historical-expert-context | alastair-crooke | stance=[strength: low] **Identity anchor:** Conflicts Forum + Substack (profile Seed). | tensions=[strength: low] **Identity anchor:** Conflicts Forum + Substack (profile Seed). | provenance=high:0,medium:0,low:1
```
