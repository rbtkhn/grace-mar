# Historical expert context — `seyed-marandi` — `2026-04`
...
```text
historical-expert-context | seyed-marandi | stance=[strength: medium] **Scaffold:** [marandi-ritter-mercouris-hormuz-scaffold](strategy-notebook-knot-2026-04-13-marandi-ritter-mercouris-hormuz-scaffold.md) — shared Hormuz week anchor — cross-day to 04-12 / 04-14 knots per header. || [strength: medium] **Parallel:** [scott-ritter-blockade-hormuz-weave](strategy-notebook-knot-2026-04-14-scott-ritter-blockade-hormuz-weave.md) — blockade mechanics + sister knots — seam not merge. | provenance=high:0,medium:2,low:0
```
