# Historical expert context — `charles-freeman` — `2026-03`
...
```text
historical-expert-context | charles-freeman | stance=[strength: low] **Repeat anchor:** chasfreeman.net — not a dated March appearance claim. | provenance=high:0,medium:0,low:1
```
