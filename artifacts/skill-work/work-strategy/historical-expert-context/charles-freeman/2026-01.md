# Historical expert context — `charles-freeman` — `2026-01`
...
```text
historical-expert-context | charles-freeman | stance=[strength: low] **Identity anchor:** Chas Freeman site + Watson visiting profile (Seed). | provenance=high:0,medium:0,low:1
```
