# Historical expert context — `charles-freeman` — `2026-02`
...
```text
historical-expert-context | charles-freeman | stance=[strength: low] **Long-form pointer:** Example interview URL in profile — verify currency before cite (profile flags this). | provenance=high:0,medium:0,low:1
```
