# Historical expert context — `robert-pape` — `2026-02`
...
```text
historical-expert-context | robert-pape | stance=[strength: low] **Repeat:** Escalation Trap Substack index — not a verified February posting calendar. | provenance=high:0,medium:0,low:1
```
