# Historical expert context — `brian-berletic` — `2026-01`
...
```text
historical-expert-context | brian-berletic | stance=[strength: low] **Identity anchor:** The New Atlas — site and channel hub (profile Seed). | provenance=high:0,medium:0,low:1
```
