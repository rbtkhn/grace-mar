# Historical expert context — `jeffrey-sachs` — `2026-01`
...
```text
historical-expert-context | jeffrey-sachs | stance=[strength: medium] **Mechanism:** **JeffSachs.org** — **U.S. War on Iran** — “attack is imminent” class interview — [interviews hub](https://www.jeffsachs.org/interviewsandmedia/tpmdr839gjx9ge4l6yfzg3g2p2m832) — **pin** exact **title/date** on page before **Links** merge. | tensions=[strength: medium] **Tension vs Quincy restraint:** Same window as **`trita-parsi`** Beltway diplomacy lane — **institutions** vs **process** emphasis — **batch-analysis** only. | shifts=[strength: high] **Through-line:** **India Today** — **7 Jan 2026** — “Iran could be next… hotter than Venezuela” — [story](https://www.indiatoday.in/world/story/jeffrey-sachs-exposes-americas-regime-change-foreign-policy-playbook-after-venezuela-2847780-2026-01-07) — **date** in URL path. | provenance=high:1,medium:2,low:0
```
