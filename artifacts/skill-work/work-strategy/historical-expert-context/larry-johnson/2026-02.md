# Historical expert context — `larry-johnson` — `2026-02`
...
```text
historical-expert-context | larry-johnson | stance=[strength: low] **Digest pointer (April-heavy):** Haiphong / Ritter / Johnson digest is **not** a February dated line — future operator cross-link only. | provenance=high:0,medium:0,low:1
```
