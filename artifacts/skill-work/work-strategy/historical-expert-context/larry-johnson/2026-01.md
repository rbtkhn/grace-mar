# Historical expert context — `larry-johnson` — `2026-01`
...
```text
historical-expert-context | larry-johnson | stance=[strength: low] **Identity anchor:** Sonar21 + Substack + X (Seed). | provenance=high:0,medium:0,low:1
```
