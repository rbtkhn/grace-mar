# Historical expert context — `max-blumenthal` — `2026-04`
...
```text
historical-expert-context | max-blumenthal | stance=[strength: low] **Identity anchor:** [Grayzone — Blumenthal](https://thegrayzone.com/author/max-blumenthal/) · [X @MaxBlumenthal](https://x.com/MaxBlumenthal) — not a dated April appearance list. || [strength: low] **Note:** Distinct from **aaron-mate** investigative ownership focus — roster seam. | provenance=high:0,medium:0,low:2
```
