# Historical expert context — `max-blumenthal` — `2026-03`
...
```text
historical-expert-context | max-blumenthal | stance=[strength: low] **Repeat anchor:** Grayzone author page — scope unchanged. | shifts=[strength: low] **Repeat anchor:** Grayzone author page — scope unchanged. | provenance=high:0,medium:0,low:1
```
