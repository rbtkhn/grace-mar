# Historical expert context — `glenn-diesen` — `2026-04`
...
```text
historical-expert-context | glenn-diesen | stance=[strength: high] **Signal (cold):** Jiang × Glenn Diesen — Iran war as petrodollar / Treasury stress — [YouTube P_DHMUdOVdo](https://www.youtube.com/watch?v=P_DHMUdOVdo) — verify:work-jiang-vi-14 + lecture markdown per ingest line. | provenance=high:1,medium:2,low:0
```
