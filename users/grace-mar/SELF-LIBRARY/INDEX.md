...
| **Xavier journal (WORK)** | [LIB-0154](../self-library.md) · [xavier-journal/](xavier-journal/) → [`docs/skill-work/work-xavier/xavier-journal/`](../../../docs/skill-work/work-xavier/xavier-journal/) | Open Brain / work-xavier day log; **symlink** under `SELF-LIBRARY/` for the same tree as the canonical path |
| **Dev journal (WORK)** | [LIB-0155](../self-library.md) · [dev-journal/](dev-journal/) → [`docs/skill-work/work-dev/dev-journal/`](../../../docs/skill-work/work-dev/dev-journal/) | Work-dev integration learning log; **symlink** under `SELF-LIBRARY/` for the same tree as the canonical path |
