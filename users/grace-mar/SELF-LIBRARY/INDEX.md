...
| **Strategy notebook (WORK)** | [strategy-notebook/](strategy-notebook/) → [`docs/skill-work/work-strategy/strategy-notebook/`](../../../docs/skill-work/work-strategy/strategy-notebook/) | Daily strategy journal + STATUS; **symlink** under `SELF-LIBRARY/` so agents that scope on `users/grace-mar/` find the same tree as the canonical path |
