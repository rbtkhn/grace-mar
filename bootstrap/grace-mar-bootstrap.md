...
| Coffee (work-start + signing-off; same **A–E**) | `.cursor/skills/coffee/SKILL.md` (fixed menu; **A–Today, B–Build, C–Compass, D–Book, E–Steward**; **no** close letter; **C** includes work-strategy-rome) — not replaced by a universal “heartbeat first line” rule |
