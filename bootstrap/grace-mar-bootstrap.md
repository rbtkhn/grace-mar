...
| Good morning / good night | `.cursor/skills/daily-warmup/SKILL.md` (fixed **A–H**; order **A,B,C,D,E,G,H,F**; **F** closes) — not replaced by a universal “heartbeat first line” rule |
