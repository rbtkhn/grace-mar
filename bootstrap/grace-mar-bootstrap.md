...
| Coffee (work-start + signing-off; same **A–G**) | `.cursor/skills/coffee/SKILL.md` (fixed menu; **A–Today, B–Build, C–Compass, D–Book, E–Steward, F–Cici next, G–Dev next**; **no** close letter; **C** includes work-strategy-rome) — not replaced by a universal “heartbeat first line” rule |
